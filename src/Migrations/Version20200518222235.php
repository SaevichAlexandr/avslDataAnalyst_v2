 ...
 */
final class Version20200518222235 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE test_table (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    }
